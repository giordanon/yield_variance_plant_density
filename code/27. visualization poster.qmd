...
y1 <- rnorm(100,0.1,0.05)*exp(x*0.022)
y2 <- rnorm(100,0.1,0.01)*exp(x*0.022)
...
ggsave("../output/plots/Presentation 1.png", width = 5, height = 4, dpi=600)
